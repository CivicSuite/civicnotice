...
- CivicNotice v0.1.0 must not call live LLMs or live agenda systems.
...
- CivicNotice may reference CivicClerk meeting concepts only through released APIs or deterministic sample data in v0.1.0.
