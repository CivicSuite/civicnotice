...
Current state: `0.1.0` notice compliance foundation release. CivicNotice does not decide legal sufficiency, publish official notices, provide legal advice, call live LLMs, write back to publication systems, or update a notice system of record. Staff own every decision.

## For IT and Technical Staff

CivicNotice is a FastAPI Python package pinned to `civiccore==0.2.0`. The current runtime exposes:
